...
# 463 "./mcc_generated_files/pin_manager.h"
...
# 547 "./mcc_generated_files/pin_manager.h"
...
# 41 "./mcc_generated_files/drivers/spi_master.h"
typedef enum {
    MAC
...
# 1 "./mcc_generated_files/datamodel/datamodel.h" 1
...
# 47 "./mcc_generated_files/datamodel/../CoAP/coap_dataInterface.h"
...
# 4 "./mcc_generated_files/datamodel/datamodel.h" 2
...
extern _Bool sistEn;
extern _Bool janAberta;
extern _Bool portAberta;

extern _Bool movdet;
extern _Bool alarmeAt;
...
void main(void)
{
    ...
    IOCBF4_SetInterruptHandler(movInterrupt);
    IOCBF5_SetInterruptHandler(btnB5Interrupt);
    IOCAF0_SetInterruptHandler(btnA0Interrupt);
    IOCBF3_SetInterruptHandler(btnB3Interrupt);
    ...
    while (1){
        ...
        if (sistEn){
            printf("sist %d, alarm %d, movdet %d, jan %d, port %d\r\n", sistEn, alarmeAt, movdet, janAberta, portAberta);
