# 1 "mcc_generated_files/cbor/cbor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/cbor/cbor.c" 2
# 43 "mcc_generated_files/cbor/cbor.c"
...
# 43 "mcc_generated_files/cbor/cbor.c" 2

# 1 "mcc_generated_files/cbor/cbor.h" 1
# 47 "mcc_generated_files/cbor/cbor.h"
...
# 47 "mcc_generated_files/cbor/cbor.h" 2


# 1 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\stdbool.h" 1 3
# 49 "mcc_generated_files/cbor/cbor.h" 2
# 90 "mcc_generated_files/cbor/cbor.h"
typedef struct
{
   uint32_t n1;
   uint32_t n2;
...
typedef enum
{
    MAJOR_UINT = 0x00 ,
    MAJOR_NEGINT = 0x20 ,
    MAJOR_BYTE_STRING = 0x40 ,
    MAJOR_TEXT_STRING = 0x60 ,
    MAJOR_ARRAY = 0x80 ,
    MAJOR_MAP = 0xA0 ,
    MAJOR_TAG = 0xC0 ,
    MAJOR_FLOATNMORE = 0xE0 ,
...
typedef struct
{
    ...
    uint8_t Array_or_Map_internalMemberLength;
} Array_or_Map_Item_t;
# 138 "mcc_generated_files/cbor/cbor.h"
void CBOR_Encode_Signed_Int(int32_t val);
# 151 "mcc_generated_files/cbor/cbor.h"
void CBOR_Encode_Unsigned_Int(uint32_t val);
# 164 "mcc_generated_files/cbor/cbor.h"
void CBOR_Encode_Byte_String(char *byteString);
# 177 "mcc_generated_files/cbor/cbor.h"
void CBOR_Encode_Text_String(const char *textString);
# 193 "mcc_generated_files/cbor/cbor.h"
void CBOR_Encode_ArrayDefinite(Array_or_Map_Item_t *Arrayelement, uint32_t length);
# 209 "mcc_generated_files/cbor/cbor.h"
void CBOR_Encode_MapsDefinite (Array_or_Map_Item_t *Map, uint32_t DataItemPairs);
# 222 "mcc_generated_files/cbor/cbor.h"
void CBOR_Encode_Bool(_Bool boolvalue);
# 238 "mcc_generated_files/cbor/cbor.h"
uint8_t CBOR_Decode_Read_Data(char *readPtr);
# 251 "mcc_generated_files/cbor/cbor.h"
int8_t CBOR_Decode_Bytes_To_Follow(uint8_t val);
# 264 "mcc_generated_files/cbor/cbor.h"
uint8_t cbor_decode_read_int(char *readPtr);
# 277 "mcc_generated_files/cbor/cbor.h"
uint8_t cbor_decode_read_string(char *readPtr);
# 290 "mcc_generated_files/cbor/cbor.h"
uint8_t cbor_decode_tags(char *readPtr);
# 303 "mcc_generated_files/cbor/cbor.h"
uint8_t cbor_decode_bool(char *readPtr);
# 316 "mcc_generated_files/cbor/cbor.h"
uint8_t cbor_elements();


void Test_Decode(int length);
void Test1_Decode(int length);
# 44 "mcc_generated_files/cbor/cbor.c" 2
...
# 48 "mcc_generated_files/cbor/cbor.c" 2
...
# 49 "mcc_generated_files/cbor/cbor.c" 2
...
# 51 "mcc_generated_files/cbor/cbor.c" 2
...
# 53 "mcc_generated_files/cbor/cbor.c" 2
...
# 54 "mcc_generated_files/cbor/cbor.c" 2


# 1 "mcc_generated_files/cbor/../TCPIPLibrary/ethernet_driver.h" 1
# 44 "mcc_generated_files/cbor/../TCPIPLibrary/ethernet_driver.h"
# 1 "mcc_generated_files/cbor/../TCPIPLibrary/tcpip_types.h" 1
# 49 "mcc_generated_files/cbor/../TCPIPLibrary/tcpip_types.h"
...
# 120 "mcc_generated_files/cbor/../TCPIPLibrary/tcpip_types.h"
typedef struct
{
    unsigned ihl:4;
    unsigned version:4;
...
# 44 "mcc_generated_files/cbor/../TCPIPLibrary/ethernet_driver.h" 2



# 1 "mcc_generated_files/cbor/../TCPIPLibrary/mac_address.h" 1
# 48 "mcc_generated_files/cbor/../TCPIPLibrary/mac_address.h"
typedef union
{
    uint8_t mac_array[6];
...
# 47 "mcc_generated_files/cbor/../TCPIPLibrary/ethernet_driver.h" 2
...
# 56 "mcc_generated_files/cbor/cbor.c" 2
# 71 "mcc_generated_files/cbor/cbor.c"
typedef struct{
    uint8_t dataType;
    uint16_t dataBytes;
...
static uint8_t cbor_uint_additional_info(uint32_t val)
{
    ...
    else if (val <= 0xFF) return 24;
    else if (val > 0xFF && val <=0xFFFF) return 25;
    else if (val > 0xFFFF && val<0XFFFFFFFF)return 26;
    else return 0;
}
static uint8_t encode_byte_follows_helper(uint8_t val)
{
    ...
    else if (val == 26) return 2;
    return 0;
}

static uint8_t decode_CBORType_helper(uint8_t val)
{
    if ((val == 0x00) || (val == 0x20)) return 0;
    else if ((val == 0x40) || (val == 0x60)) return 1;
    else if (val == 0x80) return 2;
    else if (val == 0xA0) return 3;
    else if (val == 0xC0) return 4;
    else if (val == 0xE0) return 5;
    return 0;
}
...
void CBOR_Encode_Signed_Int(int32_t val)
{
    if (val>=0)
    {
        ...
        ETH_Write8 ( 0x00 | data_tli.additionalInfo );
    }
    else
    {
        data_tli.additionalInfo = cbor_uint_additional_info(-1-val);
        ETH_Write8 ( 0x20 | data_tli.additionalInfo );
    }
    if(data_tli.additionalInfo>= 24 )
    {
        if (val>=0)
...
void CBOR_Encode_Byte_String(char *byteString)
{
    ...
    ETH_Write8 (0x40 | data_tli.additionalInfo);
    if(data_tli.additionalInfo>= 24)
    {
...
void CBOR_Encode_Text_String(const char *textString)
{
    ...
    data_tli.additionalInfo = cbor_uint_additional_info(len);
    ETH_Write8 (0x60 | data_tli.additionalInfo);
...
void CBOR_Encode_ArrayDefinite(Array_or_Map_Item_t *Array, uint32_t length)
{
    ...
    data_tli.additionalInfo = cbor_uint_additional_info(len);
    ETH_Write8 (0x80 | data_tli.additionalInfo);

    if(data_tli.additionalInfo>= 24 )
        encodefunctptr_uint_t[encode_byte_follows_helper(data_tli.additionalInfo)](length);
...
static void CBOR_Encode_ArrayHelper(Array_or_Map_Item_t *Array)
{
    ...
    ETH_Write8 (0x80 << 5 | data_tli.additionalInfo);
...
void CBOR_Encode_MapsDefinite(Array_or_Map_Item_t *Map, uint32_t DataItemPairs)
{
    ...
    ETH_Write8 (0xA0 | data_tli.additionalInfo);

    if(data_tli.additionalInfo>= 24 )
        encodefunctptr_uint_t[encode_byte_follows_helper(data_tli.additionalInfo)](DataItemPairs);
...
void CBOR_Encode_Bool(_Bool boolvalue)
{
    if (boolvalue == 1 || boolvalue == 1)
        ETH_Write8 ((0xE0 | 21));
    else if (boolvalue == 0 || boolvalue == 0)
        ETH_Write8 ((0xE0 | 20));
}
...
int8_t CBOR_Decode_Bytes_To_Follow(uint8_t val)
{
    ...
    return bytesToFollow[data_tli.additionalInfo - 24];
}
...
uint8_t CBOR_Decode_Read_Data(char *readPtr)
{
    ...
    switch(data_tli.dataType)
    {
        ...
        case 0xC0:
            ...
            break;
        case 0xE0:
            if ((0xE0 || data_tli.dataBytes == (0xE0 | 21)) ||(0xE0 || data_tli.dataBytes == (0xE0 | 20)))
...
uint8_t cbor_decode_read_int(char *readPtr)
{
    ...
    uint8_t bytesRead = 0;
        ...
        switch (data_tli.dataBytes)
        {
            case 24:
                *readPtr = ETH_Read8();
                if (data_tli.dataType == 0x20 ) *readPtr +=1;
                break;
            case 25:
                for(i=1; i>=0; i--)
                {
                ...
                if (data_tli.dataType == 0x20 ) readPtr[0] +=1;
                break;
            case 26:
                for(i=3; i>=0; i--)
                {
        ...
        else if((data_tli.dataBytes)== 24)
        {
            bytesRead = 1;
        }
        else if((data_tli.dataBytes)== 25)
        {
            bytesRead = 2;
        }
        else if((data_tli.dataBytes)== 26)
        {
            bytesRead = 4;
        }
...
uint8_t cbor_decode_tags(char *readPtr)
{
 uint8_t length = 0;
    switch (data_tli.dataBytes)
    {
            case 0:
                *readPtr = ETH_Read8();
                data_tli.dataType = (*readPtr & 0xE0);
                if (data_tli.dataType == 0x40)
                {
                    data_tli.dataBytes = (*readPtr & 0X1F);
...
{
    uint8_t length=0;
    *readPtr = (0xE0 || data_tli.dataBytes);
    return length;
}
