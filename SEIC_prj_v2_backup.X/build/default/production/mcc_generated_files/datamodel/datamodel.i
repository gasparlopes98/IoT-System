# 1 "mcc_generated_files/datamodel/datamodel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/datamodel/datamodel.c" 2
# 18 "mcc_generated_files/datamodel/datamodel.c"
...
# 18 "mcc_generated_files/datamodel/datamodel.c" 2
...
# 19 "mcc_generated_files/datamodel/datamodel.c" 2
...
# 20 "mcc_generated_files/datamodel/datamodel.c" 2
...
# 21 "mcc_generated_files/datamodel/datamodel.c" 2
...
# 22 "mcc_generated_files/datamodel/datamodel.c" 2
...
# 25 "mcc_generated_files/datamodel/datamodel.c" 2

# 1 "mcc_generated_files/datamodel/Led.h" 1
# 26 "mcc_generated_files/datamodel/datamodel.c" 2
...
static _Bool queryValid = 1;
static char resourceStr[(32)];
...
# 78 "mcc_generated_files/datamodel/datamodel.c"
...
_Bool isURIPathValid(int8_t *uri_path, uint8_t count)
{
    ...
    for(uint8_t i = 0; i< (sizeof(validPath)/sizeof(*validPath)); i++)
    {
...
uint8_t getRootToLeafPathCount()
{
    ...
    count = (sizeof(discoveryPath)/sizeof(*discoveryPath));
...
char *getDiscoveryPath(uint8_t idx)
{
    ...
    if(idx < (sizeof(discoveryPath)/sizeof(*discoveryPath)))
    {
...
int8_t getLeafResourceIdx(void)
{
    if(leafIdx < (sizeof(discoveryPath)/sizeof(*discoveryPath)))
        return leafIdx;
...
char *getStingFromIdx(uint8_t idx)
{
    ...
    for(uint8_t i = 0; i< (sizeof(StringTable)/sizeof(*StringTable)); i++)
    {
        if(idx == hptr->strIdx)
            return hptr->String;
        hptr++;
