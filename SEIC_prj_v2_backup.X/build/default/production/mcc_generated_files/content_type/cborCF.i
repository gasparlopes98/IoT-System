# 1 "mcc_generated_files/content_type/cborCF.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/content_type/cborCF.c" 2
...
# 2 "mcc_generated_files/content_type/cborCF.c" 2
...
# 3 "mcc_generated_files/content_type/cborCF.c" 2
...
# 4 "mcc_generated_files/content_type/cborCF.c" 2
...
# 5 "mcc_generated_files/content_type/cborCF.c" 2
...
# 6 "mcc_generated_files/content_type/cborCF.c" 2

# 1 "mcc_generated_files/content_type/../TCPIPLibrary/ethernet_driver.h" 1
# 44 "mcc_generated_files/content_type/../TCPIPLibrary/ethernet_driver.h"
# 1 "mcc_generated_files/content_type/../TCPIPLibrary/tcpip_types.h" 1
# 49 "mcc_generated_files/content_type/../TCPIPLibrary/tcpip_types.h"
...
# 120 "mcc_generated_files/content_type/../TCPIPLibrary/tcpip_types.h"
typedef struct
{
    unsigned ihl:4;
    unsigned version:4;
...
# 44 "mcc_generated_files/content_type/../TCPIPLibrary/ethernet_driver.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\stdbool.h" 1 3
# 45 "mcc_generated_files/content_type/../TCPIPLibrary/ethernet_driver.h" 2


# 1 "mcc_generated_files/content_type/../TCPIPLibrary/mac_address.h" 1
# 48 "mcc_generated_files/content_type/../TCPIPLibrary/mac_address.h"
typedef union
{
    uint8_t mac_array[6];
...
# 47 "mcc_generated_files/content_type/../TCPIPLibrary/ethernet_driver.h" 2
...
# 7 "mcc_generated_files/content_type/cborCF.c" 2
...
# 8 "mcc_generated_files/content_type/cborCF.c" 2
...
# 9 "mcc_generated_files/content_type/cborCF.c" 2

# 1 "mcc_generated_files/content_type/../cbor/cbor.h" 1
# 90 "mcc_generated_files/content_type/../cbor/cbor.h"
typedef struct
{
   uint32_t n1;
   uint32_t n2;
...
# 138 "mcc_generated_files/content_type/../cbor/cbor.h"
void CBOR_Encode_Signed_Int(int32_t val);
# 151 "mcc_generated_files/content_type/../cbor/cbor.h"
void CBOR_Encode_Unsigned_Int(uint32_t val);
# 164 "mcc_generated_files/content_type/../cbor/cbor.h"
void CBOR_Encode_Byte_String(char *byteString);
# 177 "mcc_generated_files/content_type/../cbor/cbor.h"
void CBOR_Encode_Text_String(const char *textString);
# 193 "mcc_generated_files/content_type/../cbor/cbor.h"
void CBOR_Encode_ArrayDefinite(Array_or_Map_Item_t *Arrayelement, uint32_t length);
# 209 "mcc_generated_files/content_type/../cbor/cbor.h"
void CBOR_Encode_MapsDefinite (Array_or_Map_Item_t *Map, uint32_t DataItemPairs);
# 222 "mcc_generated_files/content_type/../cbor/cbor.h"
void CBOR_Encode_Bool(_Bool boolvalue);
# 238 "mcc_generated_files/content_type/../cbor/cbor.h"
uint8_t CBOR_Decode_Read_Data(char *readPtr);
# 251 "mcc_generated_files/content_type/../cbor/cbor.h"
int8_t CBOR_Decode_Bytes_To_Follow(uint8_t val);
# 264 "mcc_generated_files/content_type/../cbor/cbor.h"
uint8_t cbor_decode_read_int(char *readPtr);
# 277 "mcc_generated_files/content_type/../cbor/cbor.h"
uint8_t cbor_decode_read_string(char *readPtr);
# 290 "mcc_generated_files/content_type/../cbor/cbor.h"
uint8_t cbor_decode_tags(char *readPtr);
# 303 "mcc_generated_files/content_type/../cbor/cbor.h"
uint8_t cbor_decode_bool(char *readPtr);
# 316 "mcc_generated_files/content_type/../cbor/cbor.h"
uint8_t cbor_elements();


void Test_Decode(int length);
void Test1_Decode(int length);
# 10 "mcc_generated_files/content_type/cborCF.c" 2
...
void CBORWriteData(void *data,cFMenuItems items)
{
    ...
    {
        case MAP:
            ETH_Write8(0xA0 | *value);
            break;
        case ARRAY:
             ETH_Write8(0x80 | *value);
            break;
        default:
            break;
    }
