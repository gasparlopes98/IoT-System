# 1 "mcc_generated_files/CoAP/coap_options.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/CoAP/coap_options.c" 2
# 40 "mcc_generated_files/CoAP/coap_options.c"
...
# 40 "mcc_generated_files/CoAP/coap_options.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\stdbool.h" 1 3
# 41 "mcc_generated_files/CoAP/coap_options.c" 2
...
# 42 "mcc_generated_files/CoAP/coap_options.c" 2
...
# 43 "mcc_generated_files/CoAP/coap_options.c" 2
...
int isascii(int);
int toascii(int);
# 44 "mcc_generated_files/CoAP/coap_options.c" 2
...
# 45 "mcc_generated_files/CoAP/coap_options.c" 2
...
# 46 "mcc_generated_files/CoAP/coap_options.c" 2
...
# 47 "mcc_generated_files/CoAP/coap_options.c" 2
...
# 48 "mcc_generated_files/CoAP/coap_options.c" 2


# 1 "mcc_generated_files/CoAP/coap_resources.h" 1
# 47 "mcc_generated_files/CoAP/coap_resources.h"
...
# 50 "mcc_generated_files/CoAP/coap_options.c" 2
...
# 51 "mcc_generated_files/CoAP/coap_options.c" 2
...
# 52 "mcc_generated_files/CoAP/coap_options.c" 2
...
static _Bool IsWellKnown = 0;
static _Bool IsCore = 0;
static uint8_t lastOptionNumber =0;
static Option_t opt_ptr;
static char optionStr[11];


_Bool coapObserveOptionRecvd = 0;


static void COAP_DeltaLength(void);
static _Bool COAP_DecodeOptions(Option_t *opt_ptr, coapReceive_t *ptr);
    ...
    switch(format)
    {
        case INTEGER:
            ...
            if(integerFormatOptionValue <= 0xFF)
            {
                optionLength = 1;
                COAP_DeltaLength();
                ETH_Write8(integerFormatOptionValue);
                break;
            }
            else if(integerFormatOptionValue <= 0xFFFF)
            {
                optionLength = 2;
                COAP_DeltaLength();
                ETH_Write16(integerFormatOptionValue);
                break;
            }
            else if(integerFormatOptionValue <= 0xFFFFFF)
            {
                optionLength = 3;
                COAP_DeltaLength();
                ETH_Write24(integerFormatOptionValue);
                break;
            }
            else
            {
                optionLength = 4;
                COAP_DeltaLength();
                ETH_Write32(integerFormatOptionValue);
            }
            break;
        case STRING:
            optionLength = strlen(value);
            COAP_DeltaLength();
            ETH_WriteBlock(value,optionLength);
            break;
        default:
            break;
    }
...
_Bool COAP_ParseOptions(coapReceive_t *ptr, int16_t length)
{
    ...
    ptr->optlist.content_format = TEXT_PLAIN;
    ptr->optlist.accept_format = TEXT_PLAIN;
    ...
    while(length)
    {
        ...
        if(next_byte!= 0xFF)
        {
            ...
            if(Options.opt_delta == 13)
            {
                Options.opt_delta_ext.opt_delta_ext_8 = ETH_Read8();
                opt_ptr.type = opt_ptr.type + Options.opt_delta_ext.opt_delta_ext_8;
                length -= 1;
            }
            else if(Options.opt_delta == 14)
            {
                Options.opt_delta_ext.opt_delta_ext_16 = ETH_Read16();
            ...
            if(Options.opt_length == 13)
            {
                 Options.opt_length_ext.opt_length_ext_8 = ETH_Read8();
                 ETH_ReadBlock((void *)opt_ptr.opt_value,(Options.opt_length + Options.opt_length_ext.opt_length_ext_8));
            ...
            {
                 Options.opt_length_ext.opt_length_ext_16 = ETH_Read16();
                 ETH_ReadBlock((void *)opt_ptr.opt_value,(Options.opt_length + Options.opt_length_ext.opt_length_ext_16));
            ...
            {
                ETH_ReadBlock((void *)opt_ptr.opt_value,Options.opt_length);
