# 1 "mcc_generated_files/CoAP/coap_resources.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/CoAP/coap_resources.c" 2
# 39 "mcc_generated_files/CoAP/coap_resources.c"
...
# 39 "mcc_generated_files/CoAP/coap_resources.c" 2
...
# 48 "mcc_generated_files/CoAP/coap.h" 2
...
# 40 "mcc_generated_files/CoAP/coap_resources.c" 2
...
# 41 "mcc_generated_files/CoAP/coap_resources.c" 2
...
# 43 "mcc_generated_files/CoAP/coap_resources.c" 2
...
# 45 "mcc_generated_files/CoAP/coap_resources.c" 2
# 56 "mcc_generated_files/CoAP/coap_resources.c"
_Bool firstPutEntry= 1;


static int8_t queryName[(5)];
static uint8_t vertexCount =0;
static uint8_t validQueryCount =0;



static _Bool COAP_StartGetResponse(coapReceive_t *ptr);
static _Bool COAP_ProcessPutResponse(coapReceive_t *ptr);
        ...
        case GET:
            ...
            if(ret == (1))
            {
                ...
                else
                {
                    ...
                    {
                        ETH_Write8('<');
                        ETH_WriteBlock(getDiscoveryPath(idx),getPathLength(idx));
